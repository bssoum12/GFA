<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="AddMaterialDetails.ascx.cs" Inherits="VD.Modules.Materials.AddMaterialDetails" %>
...
<script type="text/javascript" language="javascript">
    ...
    function AddFileToContainer(callbackData) {
        ...
        img.setAttribute( "onclick", "deleteElement(this.parentNode);");
                    ...
                    <tr>
                         <td valign="top" class="label_wf_td">
                            <asp:Label ID="Label1" runat="server" Text="Commentaire :" Style="margin-left: 0px">
                                        <%= DotNetNuke.Services.Localization.Localization.GetString("hTitle", ressFilePath)%>
                            </asp:Label>
                        </td>
                        <td align="left">                               
    ...
    <tr>
        <td align="center">
            <table>
                <tr>
                    <td>
                        <dxe:ASPxButton ID="cmdValider" runat="server" Text="Enregistrer" Theme="Glass" OnClick="cmdValider_Click">
