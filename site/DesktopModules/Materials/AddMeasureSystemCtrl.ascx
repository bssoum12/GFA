<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMeasureSystemCtrl.ascx.cs" Inherits="VD.Modules.Materials.AddMeasureSystemCtrl" %>
...
<dxpc:ASPxPopupControl ID="popupValidation" runat="server"
    ...
    <HeaderTemplate><%= DotNetNuke.Services.Localization.Localization.GetString("popAddMeasureSystem", ressFilePath)%></HeaderTemplate>
