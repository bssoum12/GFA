<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMaterials.ascx.cs" Inherits="VD.Modules.Materials.AddMaterials" %>
...
<dx:ASPxPageControl ID="pageControl" ClientInstanceName="pageControl" runat="server" Width="100%" ShowTabs="false"
	...
	if( rdbtnListCode.GetValue() != '0' ) txtCode.SetVisible(false); else txtCode.SetVisible(true);
                                        ...
                                        <Items>
                                            <dx:ListEditItem Text="Par Défaut" Value="0" />
                                            <dx:ListEditItem Text="Code à barre" Value="1" />
                                            <dx:ListEditItem Text="Généré" Value="2" Selected="true" />
                                        </Items>
                                ...
                                <td>
                                    <dx:ASPxTextBox ID="txtCode" runat="server" Theme="Glass" Width="100%" ClientInstanceName="txtCode" ClientVisible="false"></dx:ASPxTextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="cmbDiscipline" ClientInstanceName="cmbDiscipline" runat="server" Theme="Glass" Width="100%" DataSourceID="SqlDisciplineDS"
                                        ...
                                        <ClientSideEvents ValueChanged="function(s, e) {treeList.PerformCallback();cmbFilterSpec.PerformCallback();}"></ClientSideEvents>
                                    </dx:ASPxComboBox>
                                </td>
                                <td class="label_td">
                                    <div class="dnnTooltip" style="width: 120px;">
                                        ...
                                        <tr>
                                            <td>
                                                <dx:ASPxDropDownEdit ID="DropDownEdit" runat="server" Width="100%" ClientInstanceName="DropDownEdit"
                                                    ...
                                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="groupTabGeneral">
                                                        <RequiredField IsRequired="true" ErrorText="Le champs famille ne peut pas ètre vide !" />
                                                    </ValidationSettings>
                                                    <DropDownWindowStyle>
                                                        <Border BorderWidth="0px" />
                                                    </DropDownWindowStyle>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <dxtl:ASPxTreeList ID="treeList" runat="server" Theme="Glass" Width="100%" ClientInstanceName="treeList"
                                                                        ...
                                                                        <Columns>
                                                                            <dxtl:TreeListDataColumn Caption="Description" FieldName="Designation" AllowSort="False">
                                                                        ...
                                                                        <Templates>
                                                                            <HeaderCaption>
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                  <tr>
                                                                                    <td>
                                                                                        <dx:ASPxComboBox ID="cmbFilterSpec" ClientInstanceName="cmbFilterSpec" runat="server" DataSourceID="SqlMaterialsSpecificationDS" ValueField="ID"  Width="100%"
                                                                                        TextField="Designation" ValueType="System.String" Theme="Glass" IncrementalFilteringMode="Contains"  
                                                                                        DropDownButton-Visible="False" DropDownStyle="DropDown" OnCallback="cmbFilterSpec_Callback">
                                                                                            <ClientSideEvents ValueChanged="function(s,e){
                                                                                                var specKey = cmbFilterSpec.GetValue();
                                                                                                treeList.MakeNodeVisible(specKey);
                                                                                                treeList.SetFocusedNodeKey(specKey);
                                    ...
                                    <dx:ASPxDropDownEdit ID="DropDownEditNorm" runat="server" Width="100%" ClientInstanceName="DropDownEditNorm"
                                        ...
                                        <DropDownWindowTemplate>
                                            <dxtl:ASPxTreeList ID="treeListNorm" runat="server" Theme="Glass" Width="100%" ClientInstanceName="treeListNorm"
                                                ...
                                                ParentFieldName="ParentID" OnCustomCallback="treeListNorm_CustomCallback" OnCustomJSProperties="treeListNorm_CustomJSProperties" EnableCallbacks="true" EnableCallbackCompression="False">
                                                <SettingsBehavior AllowFocusedNode="true" />
                                                <Columns>
                        ...
                        <tr>
                            <td colspan="5">
                                ...
                                <table style="width: 100%; display: none;" id="table_tlsPropertiesGroupsNorm">
                                    <tr>
                                        <td>
                                            <dxtl:ASPxTreeList ID="tlsPropertiesGroupsNorm" ClientInstanceName="tlsPropertiesGroupsNorm" runat="server" OnHtmlRowPrepared="tlsPropertiesGroupsNorm_HtmlRowPrepared"
                        ...
                        <tr>
                            <td colspan="5">
                                <div align="right" style="padding-top: 5px; padding-bottom: 5px;">
                                    <dx:ASPxButton ID="SaveProperties" runat="server" Theme="Metropolis" Width="250px" AutoPostBack="false" Text="Sélectionner">
                    ...
                    <div align="right">
                        <table>
                            <tr>
                                ...
                                <td style="width: 100px;" align="right">
                                    <dx:ASPxButton ID="btnCancel" runat="server" Text="Annuler" ClientInstanceName="btnCancel"
                                        AutoPostBack="false" Theme="Glass">
                                        <ClientSideEvents Click="OnCancelClick" />
                                    </dx:ASPxButton>
                                </td>
...
<dxpc:ASPxPopupControl ID="popupValidation" runat="server"
    ...
    <ContentCollection>
        <dxpc:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            <table width="100%">
                ...
                <tr>
                    <td align="center">
                        <input type="button" style="width: 100px" value="Ok" onclick="popupValidation.Hide(); CloseWizard(); if (window.parent['cbOperations']) { window.parent['cbOperations'].PerformCallback('filterPop#' + txtMaterialsID.GetText()); }; if (window.parent.RefreshMaterials) { window.parent.RefreshMaterials(txtMaterialsID.GetText()); }" />
                    </td>
                </tr>
            </table>
    ...
    <HeaderTemplate><%= DotNetNuke.Services.Localization.Localization.GetString("popAjoutArticle", ressFilePath)%></HeaderTemplate>
...
<script>
    ...
    function CloseWizard() {
        //Call from stock
        if (window.parent['pupAddMaterial'])
            window.parent['pupAddMaterial'].Hide();
        //Call from devexpress popup
        if (window.parent['popupWind'])
            window.parent['popupWind'].Hide();
        //Call from dnn modal popup
    ...
    function ShowBrandEditPopup() {
        oldPopup("LoadControl.aspx?ctrl=Materials/AddBrandCtrl.ascx&mode=add", 160, 600, mn_Brands);
    }
