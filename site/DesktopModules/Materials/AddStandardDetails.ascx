<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="AddStandardDetails.ascx.cs" Inherits="VD.Modules.Materials.AddStandardDetails" %>
...
<script type="text/javascript" language="javascript">
    ...
    function SetddeParentStdText(e) {
        ddeParentStd.SetText(e);
    }
                    ...
                    <tr>
                        <td valign="top" class="label_wf_td">
                            <asp:Label ID="Label2" runat="server" Text="Commentaire :" Style="margin-left: 0px">
                                        <%= DotNetNuke.Services.Localization.Localization.GetString("lbParentStandard", ressFilePath)%>
                            </asp:Label>
                        </td>
                        <td align="left">  
                            <table style="width:100%;">
                                <tr>
                                    <td style="width:100%;">
                                        <dxe:ASPxCheckBox ID="chkIsParent" ClientInstanceName="chkIsParent" runat="server" Theme="Glass">
                                            <ClientSideEvents CheckedChanged="function(s,e){if(chkIsParent.GetChecked()){ddeParentStd.SetVisible(false);}else{ddeParentStd.SetVisible(true);}}"/>
                                        </dxe:ASPxCheckBox>
                                        <dxe:ASPxLabel ID="lblRacine" ClientInstanceName="lblRacine" runat="server" Text="Cette condition est un noeud racine" Theme="Glass"></dxe:ASPxLabel>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <dxe:ASPxDropDownEdit ID="ddeParentStd" ClientInstanceName="ddeParentStd" runat="server" Theme="Glass" Width="100%">
                                <DropDownWindowTemplate>
                                    <dx:ASPxTreeList ID="tlNorm" ClientInstanceName="tlNorm" runat="server" Theme="Glass" Width="100%" Height="100%"
                                        DataSourceID="sqlGetNorm" ParentFieldName="ParentID" KeyFieldName="ID" SettingsBehavior-AutoExpandAllNodes="true"
                                        OnDataBound="tlNorm_DataBound" >
                                        <Columns>
                                            <dx:TreeListTextColumn FieldName="Designation">
                                            </dx:TreeListTextColumn>
                                        </Columns>
                                        <Settings ShowPreview="false" GridLines="Horizontal" VerticalScrollBarMode="Auto" ScrollableHeight="350" />
                                        <SettingsBehavior AllowFocusedNode="true" />
                                        <SettingsPager Mode="ShowAllNodes"></SettingsPager>
                                        <ClientSideEvents FocusedNodeChanged="function(s,e){
                                            tlNorm.GetNodeValues(tlNorm.GetFocusedNodeKey(), 'Designation', SetddeParentStdText);}" />
                                    </dx:ASPxTreeList>
                                </DropDownWindowTemplate>
