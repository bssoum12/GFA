<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddBrandCtrl.ascx.cs" Inherits="VD.Modules.Materials.AddBrandCtrl" %>
...
<dxpc:ASPxPopupControl ID="popupValidation" runat="server"
    ...
    <ContentCollection>
        <dxpc:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            <table width="100%">
                ...
                <tr>
                    <td align="center">
                        <input type="button" style="width: 100px" value="Ok" onclick="if (window.parent.window['cmbBrands']) { window.parent.window['cmbBrands'].PerformCallback(); }; popupValidation.Hide(); if (window.parent['popupCtrl']) { window.parent['popupCtrl'].Hide(); }; if (window.parent.popupWind) { window.parent.popupWind.Hide(); }" />
                    </td>
                </tr>
            </table>
    ...
    <HeaderTemplate><%= DotNetNuke.Services.Localization.Localization.GetString("popAddBrand", ressFilePath)%></HeaderTemplate>
