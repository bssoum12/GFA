<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Param_MeasureSystem.ascx.cs" Inherits="VD.Modules.Materials.Param_MeasureSystem" %>
...
<div style="padding-bottom: 10px;">
    <dxm:ASPxMenu ID="toolbarMenu" runat="server" EnableTheming="True" Theme="Glass" AutoPostBack="false" Width="100%"  ItemAutoWidth="false">
        ...
        <Items>
            <dxm:MenuItem Name="mManageMeasureSystem" Text="Systèm de mesure" >                
...
<asp:SqlDataSource ID="SqlParamDS" runat="server" ConnectionString="<%$ ConnectionStrings:ERPConnectionString %>"
    SelectCommand="Materials_GetAllMeasureSystem" SelectCommandType="StoredProcedure"
     DeleteCommand="Materials_DeleteMeasureSystem" DeleteCommandType="StoredProcedure"
     InsertCommand="Materials_InsertMeasureSystem" InsertCommandType="StoredProcedure" 
    UpdateCommand="Materials_UpdateMeasureSystem" UpdateCommandType="StoredProcedure">
    <SelectParameters>
